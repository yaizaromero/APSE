...
with open('APSELogisticSimulator-main/data/prediccionOnline/travelModel.pkl', 'rb') as f:
    modelo_tiempo_viaje = pickle.load(f)
with open('APSELogisticSimulator-main/data/prediccionOnline/deliveryModel.pkl', 'rb') as f:
...
def obtenerPlan(evento):
    ...
    print('Se ha obtenido el plan de la BBDD para el truck_id', evento['truckId'], ' y el simulationId', evento['simulationId'])
    return
